...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        ...
        <li><a href="researcherhome.jsp">Home</a></li>
                                    ...
                                    <li><a href="download.jsp" class="selected">Download Data</a></li> 
    ...
    <div id="templatemo_main">
        <center>
            ...
            <table>
                ...
                <tr>
                    <td align="right"><font size="4" color="white">Filename</font> </td><td> 
                        <input type="text" align="left" value="<%=filename%>" size="20" placeholder="file" required name="filename"/></td>
                </tr>
                <tr></tr> <tr></tr> <tr></tr>
                 ...
                 <tr>
                    <td align="right"><font size="4" color="white">Skey</font> </td><td> 
                        <input type="text" align="left" size="20" placeholder="file" required name="skey"/></td>
                </tr>
                <tr></tr> <tr></tr> <tr></tr>
                <br>
                ...
                <tr>
                    <td>
                        ...
                        <font size="2" color="pink">
                            <input type="submit" align="right" value='Download' />
