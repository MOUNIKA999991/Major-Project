        ...
        <ul>
            <li><a href="userhome.jsp">Home</a></li>
                                    ...
                                    <li><a href="uviewreq.jsp" >View Request</a></li> 
                                     <li><a href="uviewpresc.jsp" class="selected">View Prescription</a></li> 
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
        	 <h2><font color="white">View Doctor's Prescription </font></h2>
...
try{ 
	...
	PreparedStatement pst=con.prepareStatement("select * from prescription where pname = '"+email+"' ");
...
  <tr>
 ...
     <th><font color="#ff8080"> Doctor Name </th>
 <th><font color="#ff8080"> Patient Id </th>
     <th><font color="#ff8080"> Patient Name</th>
    
      <th><font color="#ff8080">Doctor's Prescription</th>
    ...
    while(rs.next()){
            %><tr><th><%=rs.getString("doctor")%></th>
                <th><%=rs.getString("pid")%></th>
                 ...
                 <th><textarea><%=rs.getString("presc")%></textarea></th>
