...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
        	<h2>Share Prescription</h2>
            		<form action="prescriptionact2.jsp" method="post" >

            <table>
                <tr>
                    <td align="left"><font size="4" color="white"> Patient ID </font></td><td>
                        <input type="text" align="left" value="<%=pid%>" readonly placeholder="Patient ID" required size="20" name="pid"/></td>
                </tr>
                <tr></tr> <tr></tr> <tr></tr>
                ...
                <tr>
                    <td align="right"><font size="4" color="white">Patient Name</font> </td><td> 
                        <input type="text" align="left" value="<%=pname%>" size="20" placeholder="file" required name="pname"/></td>
                </tr>
                <tr></tr> <tr></tr> <tr></tr>
                 ...
                 <tr>
                    <td align="right"><font size="4" color="white">Prescription</font> </td><td> 
                        <input type="text" align="left" size="20" placeholder="pres" required name="presc"/></td>
                </tr>
                <tr></tr> <tr></tr> <tr></tr>
                <br>
                ...
                <tr>
                    <td>
                        ...
                        <font size="2" color="pink">
                            <input type="submit" align="right" value='Share' />
