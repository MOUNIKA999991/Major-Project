...
if(request.getParameter("m1")!=null){%>
    ...
    out.print("<script>alert('Key Sent Successfully..!')</script>");
}  

<%}
if(request.getParameter("m3")!=null){%>

 out.print("<script>alert('Attributes verification failed..!')</script>");
 <%
}
%>
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            <li><a href="userhome.jsp">Home</a></li>
                                    ...
                                    <li><a href="uviewreq.jsp" class="selected">View Request</a></li>    
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
        	 <h2><font color="white">View Doctor's Request & Send Skey </font></h2>
...
try{ 
	...
	PreparedStatement pst=con.prepareStatement("select * from request where pname = '"+email+"' and skey = 'waiting'");
...
  <tr>
 ...
     <th><font color="#ff8080"> Doctor </th>
 <th><font color="#ff8080"> Patient Id </th>
     <th><font color="#ff8080"> Filename</th>
    
      <th><font color="#ff8080">Doctor Attribute</th>
      <th><font color="#ff8080">Verify Attribute & Send Key </th>
     
</tr>
...
<%
    ...
    while(rs.next()){
            %><tr><th><%=rs.getString("doctor")%></th>
                <th><%=rs.getString("pid")%></th>
                 <th><%=rs.getString("filename")%></th>
                  <th><%=rs.getString("datt")%></th>
               
                
                 
                <th><a href="uviewreq2.jsp?filename=<%=rs.getString("filename")%>&pid=<%=rs.getString("pid")%>&patt=<%=rs.getString("patt")%>&datt=<%=rs.getString("datt")%>&dname=<%=rs.getString("doctor")%>">click</a></th>
