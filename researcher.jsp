    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            <li><a href="index.html">Home</a></li>
                                    <li><a href="user.jsp">Patient</a></li>  
                                    <li><a href="researcher.jsp" class="selected">Doctor</a></li>  
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
        	<h2>Doctor Login</h2>
            		<form action="relogact.jsp" method="post" >

            <table>
                <tr>
                    <td align="left"><font size="4" color="white"> E-Mail: </font></td><td>
                        <input type="text" align="left" placeholder="Enter E-Mail" required size="20" name="email"/></td>
                </tr>
                <tr></tr> <tr></tr> <tr></tr>
...
New User <a href="researcherreg.jsp">Click Here</a> To Register </center> 
          <div class="cleaner"></div>
         <!-- end of content -->
