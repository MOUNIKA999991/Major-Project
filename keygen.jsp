...
if(request.getParameter("m1")!=null){%>
    ...
    out.print("<script>alert('Key Generated Successfully..!')</script>");
}  

<%}
if(request.getParameter("m2")!=null){%>

 out.print("<script>alert('Key Generation failed..!')</script>");
 <%
}
%>
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            <li><a href="userhome.jsp">Home</a></li>
                                    ...
                                    <li><a href="keygen.jsp" class="selected">Key Generation</a></li> 
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
        	 <h2><font color="white">View Data & Encrypt the Data </font></h2>
...
try{ 
	...
	PreparedStatement pst=con.prepareStatement("select * from upload where pemail = '"+email+"' and skey = 'waiting'");
...
  <tr>
 ...
     <th><font color="#ff8080"> Patient Id</th>
     <th><font color="#ff8080"> Filename</th>
      ...
      <th><font color="#ff8080">Data</th>
      <th><font color="#ff8080">Attribute</th>
      <th><font color="#ff8080">Key Gen</th>
     
</tr>
...
<%
    ...
    while(rs.next()){
            %><tr><th><%=rs.getString("pid")%></th>
                ...
                <th><textarea><%=rs.getString("data")%></textarea></th>
                 <th><%=rs.getString("att")%></th>
                 
                <th><a href="keygen2.jsp?filename=<%=rs.getString("filename")%>&pid=<%=rs.getString("pid")%>&att=<%=rs.getString("att")%>">click</a></th>
