    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
             <li><a href="researcherhome.jsp">Home</a></li>
                                    ...
                                    <li><a href="rviewdata.jsp" class="selected">View Data</a></li> 
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
        	 <h2><font color="white">View Data & Send request </font></h2>
...
try{ 
	...
	PreparedStatement pst=con.prepareStatement("select * from encfiles");
...
  <tr>
 ...
 <th><font color="#ff8080"> Patient Name</th>
     <th><font color="#ff8080"> Filename</th>
      ...
      <th><font color="#ff8080">Send request</th>
     
</tr>
...
<%
    ...
    while(rs.next()){
            %><tr><th><%=rs.getString("pid")%></th>
                ...
                <th><a href="rviewdataact.jsp?filename=<%=rs.getString("filename")%>&patt=<%=rs.getString("att")%>&pid=<%=rs.getString("pid")%>&pname=<%=rs.getString("email")%>">click</a></th>
