    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            <li><a href="userhome.jsp">Home</a></li>
                                    ...
                                    <li><a href="uview.jsp" class="selected">View Data</a></li>   
...
to cloud.</p>
    ...
    <div id="templatemo_main">
        <center>
        	 <h2><font color="white">View Keys  </font></h2>
...
try{ 
	...
	PreparedStatement pst=con.prepareStatement("select * from encfiles where email = '"+email+"' ");
...
  <tr>
 ...
     <th><font color="#ff8080"> Patient Id</th>
     <th><font color="#ff8080"> Filename</th>
      ...
      <th><font color="#ff8080">Cipher Data</th>
     <th><font color="#ff8080">SKey</th>
 <th><font color="#ff8080">Encryption Time</th>
</tr>
...
<%
    ...
    while(rs.next()){
            %><tr><th><%=rs.getString("pid")%></th>
                ...
                <th><textarea><%=rs.getString("enc")%></textarea></th>
                 <th><%=rs.getString("skey")%></th>
               <th><%=rs.getInt("elapsedtime")%></th>
      <%  }
