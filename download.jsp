...
if(request.getParameter("m2")!=null){%>
    ...
    out.print("<script>alert('key not matched, download failed ..!')</script>");
}  

<%}
if(request.getParameter("m22")!=null){%>
...
<%
    ...
    while(rs.next()){
            %><tr><th><%=rs.getString("pid")%></th>
                ...
                <th><a href="download1.jsp?filename=<%=rs.getString("filename")%>&pid=<%=rs.getString("pid")%>&pname=<%=rs.getString("email")%>">click</a></th>
